...
class RailsControllerTest < ActionController::TestCase
  ...
  test "should create rail" do
    assert_difference('Rail.count') do
      post :create, rail: { description: @rail.description, generate: @rail.generate, pics: @rail.pics, scaffold: @rail.scaffold }
    end
  ...
  test "should update rail" do
    patch :update, id: @rail, rail: { description: @rail.description, generate: @rail.generate, pics: @rail.pics, scaffold: @rail.scaffold }
    assert_redirected_to rail_path(assigns(:rail))
  end
